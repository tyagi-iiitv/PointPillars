...
if __name__ == "__main__":
    ...
    for batch_idx in range(0,len(validation_gen)):
        [pillars, voxels], [occupancy_, position_, size_, angle_, heading_], [pts_input, gt_boxes3d] = validation_gen[batch_idx]
        ...
        for i in range(loop_range):
            ...
            _, decoded_gt_boxes3d = generate_bboxes_from_pred_and_np_array(occupancy_[i], position_[i], size_[i], angle_[i], 
                                                            heading_[i],
                                                            classification_[i], params.anchor_dims, occ_threshold=occ_threshold)
